...
const SignIn = () => {
	return (
		<form className='space-y-4 md:space-y-6' action='#'>
			...
			<button
				// type='submit'
				className='w-full bg-orange-400 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium  text-sm px-5 py-2.5 text-center '
			>
				Sign in
			</button>
