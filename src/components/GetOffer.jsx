...
const GetOffer = () => {
	return (
		<div className='flex justify-center items-center mt-28 mb-12'>
			<div className='min-w-[320px] md:min-w-[1200px] bg-orange-300  h-[230px] md:h-[300px] flex flex-row '>
				<div className=' basis-3/4 flex flex-col justify-center items-center'>
					<h1 className='w-1/2 text-xl md:text-4xl font-bold'>
					...
					<div className='w-1/2 mt-6 flex items-center'>
						...
						/>
						<button className='bg-orange-700 w-[30px] md:w-1/4 h-14 text-white text-xs md:text-2xl'>
							Sign up
						</button>
					</div>
				</div>
				<div className='bg-orange-500 md:min-w-[435px]  '>
					<img
